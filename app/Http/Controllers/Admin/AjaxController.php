    ...
    public function getBillDetail($id_bill)
    {
    	...
    	/*foreach ($bill_detail as $product) {*/
    		echo"
    			...
    			<div class='row'>
                    <div class='col-3'><p><b>Địa chỉ</b><p></div>
                    <div class='col-9'>
                        <p >".$bill->customer->users->address."</p>
                    </div>
                </div>
    			<div class='row'>
                ...
                echo"</table>
                    <hr/>
                    <div class='row'>
                        <div class='col-5' style='font-weight:bold;'>Tổng số sản phẩm:</div>
                        <div class='col-7'>".count($bill_detail)."</div>
                    </div>
                    <div class='row'>
                        <div class='col-5'  style='font-weight:bold;'>Tổng tiền hóa đơn:</div>
