                        ...
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <ol class="breadcrumb float-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{url('admin/categorys/index')  }}">Danh mục loại sản phẩm</a></li>
                                    <li class="breadcrumb-item active">Cập nhật danh mục loại sản phẩm</li>
                                </ol>
        ...
        <!-- Nested Row within Card Body -->
            ...
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Cập nhật danh mục loại sản phẩm</h1>
              </div>
                <!--start notification -->
              ...
              <form class="user" action="{{ url('admin/categorys/edit', $category->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group row">
                  <label for="name"> Tên danh mục sản phẩm</label>
                    <input type="text" class="form-control " id="name" name="name" value="{{$category->name}}" placeholder="nhập tên danh mục loại sản phẩm" >
                      @if($errors->has('name'))
                   ...
                   <div class="form-group">
                    <label for="description"> Mô tả</label>
                      <textarea class="form-control  ckeditor" id="description" name="description" >{{$category->description}}</textarea>
                        @if($errors->has('name'))
                                              <div class="error-text" style="color: red; font-family: Arial;">
                                                  {{$errors->first('name')}}
                                              </div>
                        ...
                        <label>Hình ảnh</label>
                          ...
                          <input type="file" id="file" name="image" onchange="return fileValidation()" class="inputfile"/>
                              <label for="file" class="w-100">
                               <img  src="{{ url('./public/img/logo/logo1.png') }}"  style="width:250;height: 250px;" class="rounded border image_old">
                               <div id="imagePreview"></div>
                               </label>
                           @else
                              <input type="file" id="file" name="image" onchange="return fileValidation()" class="inputfile"/>
                               <label for="file" class="w-100">
                                <img  src="{{ url('./public/img/admin/category',$category->image) }}"  style="width:250;height: 250px;" class="rounded border image_old">
                                <div id="imagePreview"></div>
                               </label>
                          @endif
                     </div>
                        ...
                        <label>Hình ảnh quảng cáo</label>
                          ...
                          <input type="file" id="file1" name="image_banner" onchange="return fileValidation1()" class="inputfile1"/>
                              <label for="file1" class="w-100">
                               <img  src="{{ url('./public/img/logo/logo1.png') }}"  style="width:250;height: 250px;" class="rounded border image_old1">
                               <div id="imagePreview1"></div>
                               </label>
                           @else
                              <input type="file" id="file1" name="image_banner" onchange="return fileValidation1()" class="inputfile1"/>
                               <label for="file1" class="w-100">
                                <img  src="{{ url('./public/img/admin/category_banner',$category->image_banner) }}"  style="width:250;height: 250px;" class="rounded border image_old1">
                                <div id="imagePreview1"></div>
                               </label>
                          @endif
                     </div>
