        ...
        <!-- Nested Row within Card Body -->
            ...
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Cập nhật hình ảnh quảng cáo</h1>
              </div>
              <!--start notification -->
                              ...
                              @endif
                               <!--end error-->
              <form class="user" action="{{ url('admin/sliders/edit',$slide->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
              <div class="row">
               <div class="col-lg-4">
                        ...
                        <div class="col-5">
                          <label>Hình ảnh</label>
                           ...
                           @else
                               <input type="file" id="file" name="image" onchange="return fileValidation()" class="inputfile"/>
                               <label for="file" class="w-100">
                                <img  src="{{ url('./public/img/admin/slides',$slide->image) }}"  style="width:300px;height: 230px;" class="rounded border image_old">
                                <div id="imagePreview"></div>
                               </label>
                          @endif
                        </div>
                  ...
                  <label for="name">Tên Quảng cáo: </label>
                   ...
                   <div class="form-group">
                    <label for="description">Mô tả</label>
                      <textarea class="form-control" id="description" name="description" style="height: 300px;" placeholder=" Nhập mô tả cho quảng cáo" >{{$slide->description}}</textarea>
                  </div>
                   </div>
                </div>
                    <div class="row">
