                    ...
                    <div class="col-xl-12">
                        <div class="card-deck" style="margin-top: 30px;margin-bottom: 30px">
                          <div class="card shadow">
                            ...
                            <a href="{{ url('manage/products/index') }}" class="text-center text-danger mb-2">Xem chi tiết</a>
                          </div>
                          <div class="card shadow">
                            ...
                            <a href="{{ url('manage/customer/index') }}" class="text-center text-danger mb-2">Xem chi tiết</a>
                          </div>
                          <div class="card shadow">
                        ...
                        <div class="col-md-4">
                            <div class="card card-product">
                              <div class="card-header card-header-image" data-header-animation="true">
                                <a href="{{url('manage/products/detail',$list->id)}}">
                              ...
                              <div class="card-body">
                                ...
                                <h4 class="card-title">
                                  <a href="{{ url('manage/products/detail',$list->id) }}" class="name_reduce">{{$list->name  }}</a>
                                </h4>
                               ...
                               <div class="price">
                                ...
                                <div class="stats">
                                 ...
                                 <div class="card-actions text-right">
                                  ...
                                  <a href="{{url('manage/products/edit',$list->id)}}" class="btn btn-success btn-link" rel="tooltip" data-placement="bottom" title="Sửa">
                              ...
                              <div class="modal-dialog modal-small">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer justify-content-center">
                                     ...
                                     <a  href="{{ url('manage/products/delete',$list->id)}}" class="btn btn-danger">Có</a>
