            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                @if(count($list_contact_header)!=0)
                   ...
                   @endforeach
                @else
                    <p class="text-center text-danger">Hiện tại chưa có thư</p>
                @endif
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                <h6 class="dropdown-header">
                  ...
                  @if(count($list_bill_header)!=0)
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="{{url('manage/bills/list_all_bill_notpayment')}}">
                  ...
                  @endif
                   <a class="dropdown-item text-center small text-gray-500" href="{{ url('manage/bills/list_all_bill_notpayment') }}">Xem tất cả</a>
              </div>
            </li>
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown">
                 ...
                 <div class="dropdown-item noti-title">
                    <h5 class="text-overflow"><small>Chào, {{ $account_users->users->name }}</small> </h5>
                                ...
                                <!-- item-->
                  <a href="{{ url('manage/profile/info_account') }}" class="dropdown-item notify-item"><i class="fa fa-user"></i> <span>Hồ Sơ</span></a>
                                <!-- item-->
                  <a href="{{ url('manage/profile/edit_password',Auth::guard('account')->user()->id) }}" class="dropdown-item notify-item"><i class="fa fa-user"></i> <span>Đổi Mật Khẩu</span></a>

                                <!-- item-->
                  <a href="{{url('client/accounts/logout')}}" class="dropdown-item notify-item"><i class="fa fa-power-off"></i> <span>Đăng Xuất</span></a>
