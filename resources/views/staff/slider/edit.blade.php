                        ...
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <ol class="breadcrumb float-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{url('manage/sliders/index')  }}">Quảng cáo động</a></li>
        ...
        <!-- Nested Row within Card Body -->
            ...
            <div class="p-5">
              ...
              <!--start notification -->
                              ...
                              @endif
                               <!--end error-->
              <form class="user" action="{{ url('manage/sliders/edit',$slide->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group row">
                  <label for="name">Tên Quảng cáo: </label>
                    <input type="text" class="form-control " id="name" name="name" value="{{$slide->name}}" placeholder=" Nhập tên quảng cáo" required="true">
                </div>
                   <div class="form-group">
                    <label for="description">Mô tả</label>
                      <textarea class="form-control" id="description" name="description" style="height: 300px;" >{{$slide->description}}</textarea>
                  </div>
                    <div class="form-group row">
                        <div class="col-5">
                          <label>Hình ảnh</label>
                           ...
                           @else
                               <input type="file" id="file" name="image" onchange="return fileValidation()" class="inputfile"/>
                               <label for="file" class="w-100">
                                <img  src="{{ url('./public/img/admin/slides',$slide->image) }}"  style="width:100%;height: 300px;" class="rounded border image_old">
                                <div id="imagePreview"></div>
                               </label>
                          @endif
                        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2"><a href="{{ url('manage/sliders/index') }}" class="btn btn-primary btn-block">Trở lại DS</a></div>
                      </div>   
              </form>
            </div>
