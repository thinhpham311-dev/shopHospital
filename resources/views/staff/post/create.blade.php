        ...
        <!-- Nested Row within Card Body -->
            ...
            <div class="p-5">
              ...
              <!--start notification -->
                              ...
                              @endif
                               <!--end error-->
              <form class="user" action="{{ url('manage/posts/create') }}" method="post">
                {{ csrf_field() }}
                <div class="form-group row">
                  ...
                  <label class="form-check-label" for="comment_status">Allow user post comments.</label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2"><a href="{{ url('manage/posts/index') }}" class="btn btn-primary btn-block"><i class="fas fa-undo-alt"></i> Trở lại DS</a></div>
                      </div>   
              </form>
            </div>
